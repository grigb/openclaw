...
const FIELD_LABELS: Record<string, string> = {
  ...
  "memory.membrane.apiKey": "Membrane API Key",
  "memory.membrane.useTls": "Membrane Use TLS",
  "memory.ingestion.enabled": "Enable Memory Ingestion",
  "memory.ingestion.async": "Async Memory Ingestion",
  "memory.ingestion.eventLogPath": "Memory Event Log Path",
  "memory.ingestion.filterToolPatterns": "Memory Ingestion Tool Filters",
  "memory.ingestion.excludeSessionTypes": "Memory Ingestion Session Exclusions",
  "memory.retrieval.maxRecords": "Memory Retrieval Max Records",
  "memory.retrieval.maxTokens": "Memory Retrieval Max Tokens",
  "memory.retrieval.minSalience": "Memory Retrieval Min Salience",
  "memory.retrieval.includeTypes": "Memory Retrieval Types",
  "memory.retrieval.defaultMaxSensitivity": "Memory Default Max Sensitivity",
  "memory.session.idFormat": "Memory Session ID Format",
  "memory.session.workingMemoryTtlHours": "Working Memory TTL (hours)",
};
...
const FIELD_HELP: Record<string, string> = {
  ...
  "memory.membrane.requestTimeoutMs": "Request timeout in ms for Membrane RPC calls (default: 30000).",
  "memory.membrane.apiKey": "Optional API key for Membrane authentication.",
  "memory.membrane.useTls": "Use TLS for Membrane connection (default: false for localhost).",
  "memory.ingestion.enabled": "Enable automatic ingestion of events to Membrane (default: true).",
  "memory.ingestion.async": "Use async (non-blocking) ingestion for performance (default: true).",
  "memory.ingestion.eventLogPath":
    "Optional path for event sourcing log (enables replay if Membrane unavailable).",
  "memory.ingestion.filterToolPatterns":
    "Tool name patterns to exclude from ingestion (e.g., read, exec).",
  "memory.ingestion.excludeSessionTypes":
    "Session types to exclude from competence learning (default: heartbeat).",
  "memory.retrieval.maxRecords": "Maximum number of records to retrieve per query (default: 20).",
  "memory.retrieval.maxTokens": "Token budget for retrieved memory context (default: 2000).",
  "memory.retrieval.minSalience":
    "Minimum salience threshold for retrieval (0-1, default: 0.3).",
  "memory.retrieval.includeTypes":
    "Memory types to include in retrieval (default: semantic, competence, working, episodic).",
  "memory.retrieval.defaultMaxSensitivity":
    "Default maximum sensitivity level for retrieval (default: medium).",
  "memory.session.idFormat":
    "Template for session IDs (default: {channel}:{type}:{uuid}).",
  "memory.session.workingMemoryTtlHours":
    "Gradual decay TTL for working memory in hours (default: 48).",
};
